...
include_once "$DOCUMENT_ROOT/login_info/login_logic.php";
?>
<!DOCTYPE html>
<html lang="en">
<head>
        	...
        	<div class="row">
            	<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
                	<div id="login">
                            ...
                            <p style="font-size: 10px;margin-top: 24px;"><b>Login With Your E-Mail & Password</b></p>
                            ...
                            <form action = "" class="login-form" method = "post">
                                ...
                                <div class="form-group">
                                    ...
                                    <p class="small" style="font-size: 8px;font-weight: 900;">
                                        <a href="reset-my-password" target="_blank">Forgot Password?</a>
                                </p>
                                </div>
                               
                                <input type="submit" href="#" class="btn_1" value="Sign in"/>
                                <div style = "font-size:18px; color:#cc0000; font-weight: 700;margin-top:10px"><?php echo $error; ?></div>
                                <hr>
                                <p style="font-size: 10px;margin-top: 24px;"><b>Don't have an account yet?</b></p>
                                <a href="sign-up" class="btn_1 outline" target="_blank" style="padding: 7px 20px;">Sign Up</a>
                            </form>
