...
include_once "$DOCUMENT_ROOT/login_info/reset_my_pwd_lgc.php";
?>
<!DOCTYPE html>
<html lang="en">
<head>
        	...
        	<div class="row">
            	<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
                	<div id="login">
                            ...
                            <p style="font-size: 8px;margin-top: 24px;text-align: center;color: #5f5756;">
                                <b style="font-weight: 600">Please Enter Your E-Mail ID, We will send the instructions to your registered mail id.</b>
                            </p>
                            <hr style="margin-top: -12px;">
                            <form action = "" class="login-form" method = "post">
                                <div class="form-group">
                                    <label>E-Mail ID</label>
                                    <input type="text" class=" form-control " name = "username" placeholder="Enter Your E-Mail Id">
                                </div>
                               
                               
                                <input type="submit" href="#" class="btn_1" value="Request"/>
                                <div style = "font-size:18px; color:#1064cc; font-weight: 700;margin-top:10px"><?php echo $error; ?></div>
                                <hr>
                                <p style="font-size: 10px;margin-top: 24px;"><b>Don't have an account yet?</b></p>
                                <a href="#" class="btn_1 outline" target="_blank" style="padding: 7px 20px;">Sign Up</a>
                            </form>
